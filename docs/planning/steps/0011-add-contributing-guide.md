0011-add-contributing-guide.md

## Step 11 — Add `CONTRIBUTING.md`

Now add the first contributor workflow document. Even though the repo is private-first, your charter says it should be open-source ready, governed, understandable, and eventually contributor-friendly. 
...
git commit -m "docs(repo): add contributing guide"
git push
````
